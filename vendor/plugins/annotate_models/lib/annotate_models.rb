...
module AnnotateModels
  ...
  def self.quote(value)
    # First make sure the constant BigDecimal is defined and special case the test.
    # If found, display BigDecimal output in a non-normalized form and quoted.
    if defined?(BigDecimal) && value == BigDecimal
      value.to_s('F')
    else
      case value
