...
#  require 'lib/sds_init.rb'
  ...
  task :setup_config_versions => :environment do
    puts "Creating original style"
    orig = ConfigVersion.create!(:name => "Original style", :version => 1.0, :template => 'xml.instruct! :xml, :version=>"1.0", :encoding=>"UTF-8"
xml.java("version" => "1.4.0", "class" => "java.beans.XMLDecoder") {
  ...
  xml.object("class" => "net.sf.sail.core.service.impl.SessionManagerImpl")
    ...
    puts "Creating 'With console logging'"
    ConfigVersion.create!(:name => "With console logging", :version => 1.1, :template => 'xml.instruct! :xml, :version=>"1.0", :encoding=>"UTF-8"
xml.java("version" => "1.4.0", "class" => "java.beans.XMLDecoder") {
